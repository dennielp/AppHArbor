...
function ImageFlow ()
{
	...
	this.defaults =
	{
		...
		aspectRatio:        5.78,         /* Aspect ratio of the ImageFlow container (width divided by height) */
		buttons:            false,          /* Toggle navigation buttons */
		captions:           false,           /* Toggle captions */
		circular:           true,          /* Toggle circular rotation */
		imageCursor:        'default',      /* Cursor type for all images - default is 'default' */
		ImageFlowID:        'imageflow',    /* Default id of the ImageFlow container */
		imageFocusM:        1.8,            /* Multiplicator for the focussed image size in percent */
		imageFocusMax:      16,              /* Max number of images on each side of the focussed one */
		imagePath:          '',             /* Path to the images relative to the reflect_.php script */
		imageScaling:       true,           /* Toggle image scaling */ 
		imagesHeight:       1.1,           /* Height of the images div container in percent */
		imagesM:            0.80,            /* Multiplicator for all images in percent */
		onClick:            function() { document.location = this.url; },   /* Onclick behaviour */
		opacity:            false,          /* Toggle image opacity */
		opacityArray:       [10,8,8,8,8],   /* Image opacity (range: 0 to 10) first value is for the focussed image */
		percentLandscape:   50,            /* Scale landscape format */
		percentOther:       47,            /* Scale portrait and square format */
