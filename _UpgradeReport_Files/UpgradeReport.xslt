...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:msxsl="urn:schemas-microsoft-com:xslt">
  ...
  <xsl:template match="Projects" mode="ProjectOverview">
    ...
    <table>
      <tr>
        <th></th>
        <th _locID="ProjectTableHeader">Проект</th>
        <th _locID="PathTableHeader">Путь</th>
        <th _locID="ErrorsTableHeader">Ошибки</th>
        <th _locID="WarningsTableHeader">Предупреждения</th>
        <th _locID="MessagesTableHeader">Сообщения</th>
      </tr>
    ...
    <tr>
      ...
      <td class="messageCell">
        ...
        <a _locID="ShowAdditionalMessages" href="#">
          ...
          Показать <xsl:value-of select="@MessageCount"/> дополнительные сообщения
        </a>
      </td>
    </tr>
  </xsl:template>
    ...
    <tr style="display: none">
      ...
      <td class="messageCell">
        ...
        <a _locID="HideAdditionalMessages" href="#">
          ...
          Скрыть <xsl:value-of select="@MessageCount"/> дополнительные сообщения
        </a>
      </td>
    </tr>
  </xsl:template>
    ...
    <xsl:for-each select="Project">
      ...
      <table>
        <tr>
          ...
          <th></th>
          <th class="messageCell" _locID="MessageTableHeader">Сообщение</th>
        </tr>
          ...
          <xsl:when test="@TotalCount = 0">
            <tr>
              ...
              <td class="messageCell" _locID="NoMessagesRow">
                <xsl:value-of select="@ProjectDisplayName"/> сообщения не зарегистрированы.
              </td>
            </tr>
          </xsl:when>
        </xsl:choose>
    ...
    <html>
      ...
      <body>
        <h1 _locID="ConversionReport">
          Отчет о миграции - <xsl:value-of select="Properties/Property[@Name='Solution']/@Value"/>
        </h1>

        <div id="content">
          <h2 _locID="OverviewTitle">Обзор</h2>
          ...
          <h2 _locID="SolutionAndProjectsTitle">Решение и проекты</h2>
